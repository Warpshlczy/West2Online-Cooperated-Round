  ...
  <div>
    <div id="frame">
      ...
      <form>
        ...
        <img :src="fundInfo.ps" class="uploadImg" /><br /><br />
        <div id="money">
          <input
            type="button"
            value="通过审核"
            class="btn btnBase"
            @click="passOperation(true)"
          /><br /><br />
          <input
            type="button"
            value="不通过审核"
            class="btn btnBase no"
            @click="passOperation(false)"
          /><br />
        </div>
        <br />
      </form>
...
#frame {
  ...
  box-shadow: 0 0 0 10px #960000;
  border: 10px solid #960000;
